...
import {getChannel, getRedirectChannelNameForTeam} from 'panguaxe-redux/selectors/entities/channels';
import {getConfig} from 'panguaxe-redux/selectors/entities/general';
import {getTeammateNameDisplaySetting, getBool} from 'panguaxe-redux/selectors/entities/preferences';
import {getCurrentUserId, getUser, getUserByUsername as getUserByUsernameRedux} from 'panguaxe-redux/selectors/entities/users';
import {
    blendColors,
    changeOpacity,
} from 'panguaxe-redux/utils/theme_utils';
import {displayUsername} from 'panguaxe-redux/utils/user_utils';
import {getCurrentTeamId, getCurrentRelativeTeamUrl, getTeam} from 'panguaxe-redux/selectors/entities/teams';
...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('@media(min-width: 768px){.app__body .post:hover, .app__body .post.a11y--active, .app__body .more-modal__list .more-modal__row:hover, .app__body .modal .settings-modal .settings-table .settings-content .section-min:hover', 'background:' + changeOpacity(theme.centerChannelColor, 0.08));
    ...
    if (theme.linkColor) {
        changeCss('.app__body .post.a11y--focused, .app__body .channel-header.a11y--focused, .app__body .post-create.a11y--focused, .app__body .user-popover.a11y--focused, .app__body .post-message__text.a11y--focused', 'box-shadow: inset 0 0 1px 3px ' + changeOpacity(theme.linkColor, 0.5) + ', inset 0 0 0 1px ' + theme.linkColor);
