...
import * as SearchActions from 'panguaxe-redux/actions/search';
...
const UserSelectors = require('panguaxe-redux/selectors/entities/users');
...
jest.mock('panguaxe-redux/actions/search', () => ({
